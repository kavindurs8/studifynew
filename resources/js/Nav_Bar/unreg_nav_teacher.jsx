      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-6">
            ...
            <Link href="/teacher/dashboard" className="flex items-center space-x-2 text-base font-medium text-black hover:text-blue-600">
              <FaUser />
              <span>Sign in</span>
            </Link>

            <Link href="/" className="inline-flex items-center px-6 py-3 text-base font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors">
              <FaStore className="mr-2" /> For Students
            </Link>
          </div>
          ...
          <nav className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
            <div className="flow-root">
              <div className="flex flex-col px-6 -my-2 space-y-1">
                ...
                <Link href="/teacher/dashboard" className="py-2 text-base font-medium text-black hover:text-blue-600">Sign in</Link>
              </div>
            </div>

            <div className="px-6 mt-6">
              <Link href="/" className="inline-flex justify-center w-full px-4 py-3 text-base font-semibold text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700">
                For Students
              </Link>
            </div>
          </nav>
